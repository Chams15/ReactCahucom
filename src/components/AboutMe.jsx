  ...
  return (
    <section className="max-w-screen-xl px-6 mx-auto py-10 md:py-24" id="about">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:gap-4">
        ...
        <div className="col-span-2 bg-gradient-to-br from-green-950 to-slate-900 rounded-lg border border-green-800/40 p-6">
          <p className="text-green-50 text-xs md:text-[13px] font-normal text-justify leading-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
        <InfoCard
          ...
          lable="Years of Chilling"
        />

        <InfoCard
          count={ABOUT_ME_DATA.stats.numberOfProjects}
          lable="Chilling Completed Successfully"
        />
...
const InfoCard = ({ lable, count }) => {
  return (
    <div className="bg-gradient-to-br from-green-950 to-slate-900 rounded-lg border border-green-800/40 px-4 md:px-6 py-3">
      <h6 className="text-primary text-xl md:text-2xl font-semibold">
        {count}
      </h6>
      
      <span className="text-green-300 text-xs md:text-sm font-thin">
        {lable}
      </span>
    </div>
  );
